...
main: main.o main_window.o order.o serving.o scoop.o container.o topping.o item.o login.o
	$(CXX) $(CXXFLAGS) -o main main.o main_window.o order.o serving.o scoop.o container.o topping.o item.o login.o `pkg-config gtkmm-3.0 --cflags --libs`
	./main
